...
module.exports = {
	...
	rules: {
		...
		"valid-jsdoc": ["error", { prefer: { arg: "param", argument: "param", constructor: "class", return: "returns" }, preferType: { object: "Object", string: "String", number: "Number", bool: "Boolean", boolean: "Boolean", function: "Function" }, requireReturn: false, requireReturnType: true, requireParamDescription: true, requireReturnDescription: true }],	//	enforce valid JSDoc comments
		...
		indent: ["error", "tab", { VariableDeclarator: 0 }], //	autofixable enforce consistent indentation
